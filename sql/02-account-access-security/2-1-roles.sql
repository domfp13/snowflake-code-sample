...
-- 9.- Creating a table
USE ROLE ANALYST;
SELECT C_MKTSEGMENT, COUNT(*) AS COUNT_OF_MKTSEGMENT FROM SNOWFLAKE_CODE_SAMPLE.PUBLIC.CUSTOMER GROUP BY ALL;
...
USE ROLE SYSADMIN;
USE WAREHOUSE SCS;
SHOW TABLES IN SCHEMA SNOWFLAKE_CODE_SAMPLE.PUBLIC; -- Table is not longer visible, how can we change this behavior?
...
GRANT OWNERSHIP ON FUTURE TABLES IN SCHEMA SNOWFLAKE_CODE_SAMPLE.PUBLIC TO ROLE SYSADMIN; -- This will guarantee that all future tables will be owned by SYSADMIN.
